...
# 读取原始实验数据
data_path = r'd:\MIR_LLVM_NEW\rustls\results\20260604_201435\experiment_results.csv'
...
# 保存映射表
mapping_path = r'd:\MIR_LLVM_NEW\rustls\analysis\config_to_pass_mapping.csv'
...
summary_path = r'd:\MIR_LLVM_NEW\rustls\results\20260604_201435\summary_medians.csv'
