...
RESULTS_ROOT = os.path.abspath(os.path.join(BASE_DIR, "..", "..", "results_expanded"))
PREFERRED_RESULTS_DIR = os.path.join(RESULTS_ROOT, "20260620_123353")
OUTPUT_DIR = BASE_DIR
...
def find_latest_results_dir():
    if os.path.isdir(PREFERRED_RESULTS_DIR) and os.path.exists(
        os.path.join(PREFERRED_RESULTS_DIR, "experiment_results.csv")
    ):
        return PREFERRED_RESULTS_DIR
