"""
功能：仅 MIR Pass 的随机/遍历实验脚本
描述：
    专注于 MIR 层的 Pass 组合实验（不涉及 LLVM 层的变化）。
    用于分析 MIR 优化对性能的独立影响。
"""
import json
import os
...
DEFAULT_SEARCH_SPACE = "/mnt/fjx/Compiler_Experiment/table/table_json/mir_experiment_matrix_off.json"
