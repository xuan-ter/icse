...
DEFAULT_CSV_PATH = r"d:\MIR_LLVM\mir_-llvm\ripgrep\results\experiment_results.csv"
DEFAULT_OUT_PATH = r"d:\MIR_LLVM\mir_-llvm\ripgrep\analysis\best_configs_summary.csv"
...
def main():
    parser = argparse.ArgumentParser(description="Find best configs from experiment_results.csv (ripgrep)")
