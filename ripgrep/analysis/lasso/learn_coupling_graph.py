...
RIPGREP_DID_INTERACTION_CSV = r"d:\MIR_LLVM\mir_-llvm\ripgrep\analysis\did\interaction_results.csv"
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    if use_proxy and os.path.exists(RIPGREP_DID_INTERACTION_CSV):
        proxy_edges = _edges_from_did_proxy(RIPGREP_DID_INTERACTION_CSV, top_n=int(args.proxy_top_n))
        if args.proxy == "force":
            edges = proxy_edges
        else:
