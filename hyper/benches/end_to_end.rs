...
#[bench]
fn http1_consecutive_x1_both_50mb(b: &mut test::Bencher) {
    let body = &[b'x'; 1024 * 1024 * 50];
    opts()
        .method(Method::POST)
        .request_body(body)
        .response_body(body)
...
#[bench]
fn http1_consecutive_x1_both_100mb(b: &mut test::Bencher) {
    let body = &[b'x'; 1024 * 1024 * 100];
    opts()
        .method(Method::POST)
        .request_body(body)
        .response_body(body)
