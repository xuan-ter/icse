...
# 读取原始实验数据
data_path = r'd:\MIR_LLVM_NEW\hyper\results\20260531_191832\experiment_results.csv'
...
# 保存映射表
mapping_path = r'd:\MIR_LLVM_NEW\hyper\analysis\config_to_pass_mapping.csv'
...
summary_path = r'd:\MIR_LLVM_NEW\hyper\results\20260531_191832\summary_medians.csv'
