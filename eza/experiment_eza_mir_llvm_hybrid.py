...
PROJECT_ROOT = "/root/MIR_LLVM/eza"
WORKSPACE_ROOT = "/root/MIR_LLVM"
DEFAULT_JSON_PATH = "/root/MIR_LLVM/table/table_json/combined_experiment_matrix.json"
DEFAULT_RESULTS_ROOT = "/root/MIR_LLVM/eza/results"
DEFAULT_LIST_PATH = "/root/MIR_LLVM/bat"
BENCH_VARIANT = "eza"
...
def measure_combination(combo, runs, skip_clean, list_path, run_repeats, warmup, extra_args, logf):
    ...
    msg3 = f"[Run] runs={runs}, repeats={run_repeats}, warmup={warmup}, path={list_path}"
    print(msg1)
    print(msg2)
    print(msg3)
    logf.write(msg1 + "\n")
...
def main():
    ...
    parser.add_argument("--list-path", default=DEFAULT_LIST_PATH)
    parser.add_argument("--run-repeats", type=int, default=500)
    ...
    if not os.path.exists(list_path):
        raise SystemExit(f"List path not found: {list_path}")
