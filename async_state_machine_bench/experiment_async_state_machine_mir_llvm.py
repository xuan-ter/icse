...
PROJECT_ROOT = "/root/MIR_LLVM/async_state_machine_bench"
...
DEFAULT_RESULTS_ROOT = "/root/MIR_LLVM/async_state_machine_bench/results"
...
def run_binary(env, variant, n, depth):
...
def main():
    ...
    ap.add_argument("--variants", default="S,B,L")
